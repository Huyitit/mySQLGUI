...
/**
 * Add Book Panel: Add new books to database with authors and genres
 * 3-step wizard: Book info → Select authors → Select genres
 */
    ...
    private void addBookToDatabase() {
        ...
        SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
            ...
            protected Boolean doInBackground() throws Exception {
                ...
                try {
                    conn = com.library.database.ConnectionManager.getInstance().getConnection();
